...
public class IndexedZipFileTest extends TestCase {
  ...
  public void testMessageDigester() throws Exception {
    ...
    assertTrue(Arrays.equals(
        new byte[]{-108, -65, -99, 37, -58, 106, 97, -113, -51, 20, 99, -94, -110, 26, -20, 22},
        digest));
  ...
  public void testUnicodeFilenames() throws Exception {
    ...
    byte[] unicode = {
        ...
        0x28, 0x59, 0x7E, (byte) 0xD0, 0x01, 0x49, 0x00, (byte) 0xEB, (byte) 0xF7, 0x58, 0x7E,
        (byte) 0xD0,
  ...
  public void testDeflatedEntries() throws Exception {
    byte[] zipfile = {
        ...
        (byte) 0x98, 0x46, (byte) 0xD9, (byte) 0x82, 0x6A, (byte) 0xB8, 0x14, 0x00, 0x00, 0x00,
        (byte) 0xB0, 0x0A,
        0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x61, 0x2E, 0x74, 0x78, 0x74, (byte) 0xED,
        (byte) 0xC1, 0x31, 0x01, 0x00, 0x00, 0x00, (byte) 0xC2, (byte) 0xA0, (byte) 0xAC,
        (byte) 0xF6, 0x2F, 0x61,
        ...
        0x3E, (byte) 0xBB, 0x59, 0x7E, (byte) 0xD0, 0x01, (byte) 0xBF, 0x45, (byte) 0xD6,
        (byte) 0xB2, 0x59, 0x7E,
        (byte) 0xD0, 0x01, (byte) 0xBF, 0x45, (byte) 0xD6, (byte) 0xB2, 0x59, 0x7E, (byte) 0xD0,
        0x01, 0x50, 0x4B,
  ...
  public void testEmptyInputStream() throws Exception {
    byte[] withempty = {
        ...
        0x5A, 0x7E, (byte) 0xD0, 0x01, 0x65, (byte) 0xFC, 0x7E, (byte) 0x82, 0x5A, 0x7E,
        (byte) 0xD0, 0x01,
  ...
  public void testUnknownCompressionMethod() throws Exception {
    byte[] rawData = {
        ...
        0x31, 0x1B, (byte) 0xCA, (byte) 0xAB, 0x6A, (byte) 0xC0, 0x13, 0x5B, (byte) 0xB5,
        (byte) 0x8A, (byte) 0xD2, (byte) 0xA3,
        0x70, (byte) 0xDF, 0x53, 0x76, (byte) 0x8E, (byte) 0xD5, (byte) 0x84, 0x00, 0x50, 0x4B,
        0x01, 0x02,
        ...
        0x18, 0x00, (byte) 0x89, 0x6E, 0x6F, (byte) 0x8D, 0x5B, 0x7E, (byte) 0xD0, 0x01,
        (byte) 0x9B, 0x10,
  ...
  public void testInternalsOfZeroPaddedInputStream() throws Exception {
    ...
    {
      Class<?> aClass = IndexedZipFile.class.getClassLoader().loadClass(
          "rocks.appconcept.javatools.zip.IndexedZipFile$ZeroPaddedByteArrayInputStream");
  ...
  public void testFilenameEncodings() throws Exception {
    ...
    List<Integer> allIndexes = ByteArrayFinder
        .findAllIndexes(filename.getBytes(StandardCharsets.UTF_8), b);
