...
public class JSONObjectTest extends TestCase {
  ...
  public void testSimpleObject() throws Exception {
    ...
    assertEquals(new HashSet<>(Arrays.asList(JSONObject.string("c"), JSONObject.number(17.53))),
        new HashSet<>(parsed.values()));
  ...
  public void testSimpleList() throws Exception {
    ...
    assertEquals(
        Arrays.asList(JSONObject.string("a"), JSONObject.number(17.53), JSONObject.string("b")),
        parsed.values());
    assertEquals(0, parsed.entrySet().size());
  ...
  public void testObjectManipulation() throws Exception {
    ...
    for (Iterator<Map.Entry<String, JSONObject>> iterator = parsed.entrySet().iterator();
        iterator.hasNext(); ) {
