...
public class JSONStreamTest extends TestCase {
    ...
    public void testList() {
        ...
        {
            JSONStream st = new JSONStream();
            st.list().list().list().value("apa").endlist().list().value("ninja").endlist().endlist().endlist();
    ...
    public void testComplex() {
        ...
        assertEquals("{\"version\":1,\"quotes\":[{\"id\":0,\"owner\":\"user 0\",\"odd\":false},{\"id\":1,\"owner\":\"user 1\",\"odd\":true},{\"id\":2,\"owner\":\"user 2\",\"odd\":false}]}", st.toJSON());
