...
public class JSONTest extends TestCase {
    ...
    public static class BeanWithArray {
        ...
        public List<List<List<String>>> innerList2 = Collections.singletonList(Collections.singletonList(Arrays.asList("apa", "bil")));
    ...
    public static class BeanWithMap {
        ...
        public Map<String, BeanWithArray> stringToBeans = Collections.singletonMap("prop", new BeanWithArray());
    ...
    public void testStringify() throws Exception {
        assertEquals("toJSON methods should be called if present", "\"hello there\"", JSON.stringify(new BeanWithToJSON()));
    ...
    public void testRoundTrips() throws Exception {
        assertEquals(new BeanWithAggregate(), JSON.parse(BeanWithAggregate.class, JSON.stringify(new BeanWithAggregate())));
        assertEquals(new BeanWithArray(), JSON.parse(BeanWithArray.class, JSON.stringify(new BeanWithArray())));
        assertEquals(new BeanWithMap(), JSON.parse(BeanWithMap.class, JSON.stringify(new BeanWithMap())));
    }
