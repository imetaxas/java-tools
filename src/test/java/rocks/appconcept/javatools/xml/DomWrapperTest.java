...
public class DomWrapperTest extends TestCase {
    ...
    public void testHappyPaths() throws Exception {
        ...
        DomWrapper el = DomWrapper.parseNS(new ByteArrayInputStream(xml.getBytes(Charset.forName("UTF-8"))));
    ...
    public void testWithoutNamespace() throws Exception {
        ...
        DomWrapper el = DomWrapper.parse(new ByteArrayInputStream(xml.getBytes(Charset.forName("UTF-8"))));
