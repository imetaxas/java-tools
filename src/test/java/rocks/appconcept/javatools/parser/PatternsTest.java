...
public class PatternsTest extends TestCase {
  ...
  public void testReplaceAll() throws Exception {
    ...
    assertEquals("[1],[2],[3],[4],[5]",
        Patterns.replaceAll(pattern, "1,2,3,4,5", m -> "[" + m.group(0) + "]"));
    assertEquals("babbel[1],[2],[3],[4],[5]dravel",
        Patterns.replaceAll(pattern, "babbel1,2,3,4,5dravel", m -> "[" + m.group(0) + "]"));
    //noinspection Convert2Lambda
    assertEquals("babbel[1],[2],[3],[4],[5]dravel",
        Patterns.replaceAll(pattern, "babbel1,2,3,4,5dravel", new Patterns.Replacer() {
          @Override
  ...
  public void testReplaceToStringBuilder() throws Exception {
    ...
    Patterns.replaceAll(pattern, "[1],[2]", out,
        r -> Integer.toString(Integer.parseInt(r.group(1)) * 20));
