...
public class JSONPrettify {
    ...
    private static void print(JSONObject parse, StringBuilder out, String prefix, String indentation) {
        if (parse == JSONObject.TRUE) {
            ...
            out.append("{\n");
            for (Iterator<Map.Entry<String, JSONObject>> iterator = parse.entrySet().iterator(); iterator.hasNext(); ) {
