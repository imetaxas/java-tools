...
public class ByteArrayFinder {
  ...
  /**
   * Return all indexes where the specified pattern occurs in the data. It will not find overlapping
   * indexes, i.e finding "aa" in "aaaa" will return [0, 2] and not [0,1,2].
   *
   * @param pattern The pattern to search for
   * @param data The data to look for the pattern in
   * @return List of integer indexes where the pattern occurs or an empty list if no occurrences
   * were found.
   */
