...
public final class Patterns {
    ...
    /**
     * Replaces all matches of the specified pattern from the input with the result of calling the specified replacer method.
     ...
     * @param replacer The replacer to use.
     */
    public static void replaceAll(final Pattern pattern, final String input, StringBuilder out, Replacer replacer) {
        int lastEnd = 0;
