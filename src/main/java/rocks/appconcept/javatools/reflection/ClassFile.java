...
public class ClassFile {
    ...
    public void addMethod(int accessFlags, String name, String signature, short maxStack, short maxLocals, CodeWriter codeWriter) {
    ...
    private static class Method {
        ...
        public Method(int accessFlags, String name, String signature, short maxStack, short maxLocals, CodeWriter codeWriter) {
            this.accessFlags = accessFlags;
            this.name = name;
        ...
        public void write(ConstantPool constantPool, DataOutputStream out) throws IOException {
            ...
            out.writeInt(2);
            out.writeShort(constantPool.getUtf8(signature));
            byte[] code = StreamUtils.captureBytes(s -> codeWriter.write(constantPool, new DataOutputStream(s)));
    ...
    public static class ConstantPool {
        ...
        public short getFieldRef(String className, String fieldName, String signature) {
            return getIndex(ClassConstants.CONSTANT_FIELD, getClass(className), getNameAndType(fieldName, signature));
        }

        public short getMethodRef(String className, String name, String descriptor) {
            return getIndex(ClassConstants.CONSTANT_METHOD, getClass(className), getNameAndType(name, descriptor));
        }
        ...
        private static class ConstantPoolEntry {
            ...
            public void write(DataOutputStream out) throws IOException {
                if (value instanceof String) {
                    ...
                    if (tag == ClassConstants.CONSTANT_FIELD || tag == ClassConstants.CONSTANT_METHOD || tag == ClassConstants.CONSTANT_INTERFACEMETHOD || tag == ClassConstants.CONSTANT_NAMEANDTYPE) {
